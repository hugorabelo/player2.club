...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::get('campeonato/tabelaPublica/{id}', 'CampeonatosController@getTabelaPublica');
    Route::get('campeonatoPublico/{id}', 'CampeonatosController@showPublico');
    Route::get('faseGrupo/partidasPorRodadaPublico/{rodada}/{idGrupo}', 'FaseGrupoController@getPartidasPorRodadaPublico');
    Route::get('faseGrupoPublico/{id}', 'FaseGrupoController@showPublico');
    
    Route::get('times/baseFifa', 'TimeController@getBaseFifa');
});
