...
<div class="row">
    <div class="col-md-10 col-md-offset-2">
        <h1>{{ trans('messages.usuarioGrupo_create') }}</h1>
...
{{ Form::open(array('route' => 'usuarioGrupos.store', 'class' => 'form-horizontal')) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('usuarioGrupos.index', trans('fields.cancel'), '', array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
